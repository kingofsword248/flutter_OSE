...
abstract class RefundPurchaseRepository {
  Future<List<RefundDTO>> loadRefundP(int id);
}

class RefundPurchaseRepositoryIml implements RefundPurchaseRepository {
  ...
  Future<List<RefundDTO>> loadRefundP(int id) async {
    String url =
        "https://old-stuff-exchange-api.herokuapp.com/api/refund/getListRefundPurcharse/";
    try {
      Map data = {"id": "$id"};
